...
export const skillCategories: { title: string; shortLabel: string; skills: string[] }[] = [
  ...
  },
  {
    ...
    shortLabel: "DevOps",
    skills: [
      "AWS (SageMaker, Lambda, S3, EC2, CloudFront, MediaConvert, CodeDeploy, Cognito, Secrets Manager, ALB, Bedrock)",
  ...
  },
  {
    ...
    skills: [
      ...
      "Model Quantization",
      "RAGAS Evaluation",
      "Agentic AI (ReAct-style, no framework)",
      "LLM Serving",
...
export const moreProjects: MoreProject[] = [
  ...
  {
    title: "Fake-Review Data Pipeline",
    description:
      "Selenium/BeautifulSoup pipeline scraping and structuring Amazon review data for fake-review research — data collection and preprocessing, not a trained detector.",
  ...
  {
    title: "Social-Text Readability & Sentiment EDA",
    description:
      "R-based descriptive-statistics analysis of readability and sentiment patterns in social-media text.",
    tags: ["R", "EDA", "Sentiment Analysis"],
  ...
  {
    title: "Twitter Data Collection Pipeline",
    description:
      "Tweepy-based scraping and preprocessing pipeline for social-media content data — data collection, not a bot-detection system.",
    tags: ["NLP", "Web Scraping", "Tweepy"],
